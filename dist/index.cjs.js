...
var Icon$15 = function(props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 81 65" }, props),
        React__default['default'].createElement("image", { width: 81, height: 65, href: "/images/custom/rival-token.png" })));
};
...
var CakePrice = function(_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://swap.bitrivals.gg/swap?outputCurrency=0xC3c0Fd8325E25200fCBd68611449FAc9b9ac29bD", target: "_blank" },
...
var Step = function(_a) {
    ...
    return (React__default['default'].createElement(StyledStep, { mb: index < numberOfSteps - 1 ? "16px" : 0 },
        ...
        React__default['default'].createElement(Wrapper$2, null,
            ...
            React__default['default'].createElement(Connector, { "$isFirstStep": isFirst, "$isLastStep": isLast, status: statusFirstPart, "$isFirstPart": true }), !isFirst && !isLast && React__default['default'].createElement(Connector, { "$isFirstStep": isFirst, "$isLastStep": isLast, status: statusSecondPart })),
    ...
    return (React__default['default'].createElement(ModalContainer, __assign({ minWidth: minWidth }, props),
        React__default['default'].createElement(ModalHeader, { background: getThemeValue("colors." + headerBackground, headerBackground)(theme) },
            React__default['default'].createElement(ModalTitle, null,
                ...
                React__default['default'].createElement(Heading, null, title)), !hideCloseButton && React__default['default'].createElement(ModalCloseButton, { onDismiss: onDismiss })),
    ...
    return (React__default['default'].createElement(Box, __assign({ ref: isBottomNav ? null : setTargetRef }, props),
        ...
        hasItems && (React__default['default'].createElement(StyledDropdownMenu, __assign({ style: styles.popper, ref: setTooltipRef }, attributes.popper, { "$isBottomNav": isBottomNav, "$isOpen": isOpen && ((isBottomNav && showItemsOnMobile) || !isBottomNav) }), items
            ...
            .map(function(_a, itemItem) {
                var _b = _a.type,
                    type = _b === void 0 ? exports.DropdownMenuItemType.INTERNAL_LINK : _b,
                    label = _a.label,
                    _c = _a.href,
                    href = _c === void 0 ? "/" : _c,
                    status = _a.status,
...
var MenuItem = function(_a) {
    ...
    return (React__default['default'].createElement(StyledFooter, __assign({ p: ["40px 16px", null, "56px 40px 32px 40px"] }, props, { justifyContent: "center" }),
        React__default['default'].createElement(Flex, { flexDirection: "column", width: ["100%", null, "1200px;"] },
            ...
            React__default['default'].createElement(Flex, { order: [2, null, 1], flexDirection: ["column", null, "row"], justifyContent: "space-between", alignItems: "flex-start", mb: ["0px", null, "36px"] },
                React__default['default'].createElement(Box, { display: ["none", null, "block"] },
                    React__default['default'].createElement(LogoWithTextIcon, { isDark: true, width: "152px" })), items === null || items === void 0 ? void 0 :
            ...
            React__default['default'].createElement(StyledSocialLinks, { order: [2], pb: ["24px", null, "32px"], mb: ["0", null, "32px"] }),
            React__default['default'].createElement(StyledToolsContainer, { order: [1, null, 3], flexDirection: ["column", null, "row"], justifyContent: "space-between" },
                React__default['default'].createElement(Flex, { order: [2, null, 1], alignItems: "center" },
                    React__default['default'].createElement(Text, { color: "tertiary", fontSize: "13px", display: ["none", null, "block"] }, "Copyright 2021 Bit Rivals. All rights reserved worldwide.")),
                React__default['default'].createElement(Flex, { order: [1, null, 2], mb: ["24px", null, "0"], justifyContent: "space-between", alignItems: "center" },
                    ...
                    React__default['default'].createElement(Button, { as: "a", href: "https://swap.bitrivals.gg/swap?outputCurrency=0xC3c0Fd8325E25200fCBd68611449FAc9b9ac29bD", target: "_blank", scale: "sm", endIcon: React__default['default'].createElement(Icon$24, { color: lightColors.backgroundAlt }) }, buyCakeLabel))),
            React__default['default'].createElement(Flex, { order: [3, null, 4] },
                React__default['default'].createElement(Text, { color: "tertiary", fontSize: "13px", display: ["block", null, "none"] }, "Copyright 2021 Bit Rivals. All rights reserved worldwide.")))));
};
...
var Logo = function(_a) {
    ...
    return (React__default['default'].createElement(Flex, { alignItems: "center" }, isAbsoluteUrl ? (React__default['default'].createElement(StyledLink, { as: "a", href: href, "aria-label": "Pancake home page" }, innerLogo)) : (React__default['default'].createElement(StyledLink, { to: href, "aria-label": "Pancake home page" }, innerLogo))));
};
...
var Menu$1 = function(_a) {
    ...
    return (React__default['default'].createElement(Wrapper, null,
        React__default['default'].createElement(StyledNav, { showMenu: showMenu },
            React__default['default'].createElement(Flex, { alignItems: "center" },
                React__default['default'].createElement(Logo$1, { isDark: isDark, href: (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "/" }), !isMobile && React__default['default'].createElement(MenuItems, { items: links, activeItem: activeItem, activeSubItem: activeSubItem, ml: "24px" })),
            React__default['default'].createElement(Flex, { alignItems: "center" }, !isMobile && (React__default['default'].createElement(Box, { mr: "12px" },
...
var UserMenu = function(_a) {
    ...
    return (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement(StyledUserMenu, __assign({ ref: setTargetRef }, props),
            ...
            React__default['default'].createElement(Icon$1O, { color: "text", width: "24px" })),
...
exports.AccountFilledIcon = Icon$2b;
exports.AccountIcon = Icon$2c;
exports.AddIcon = Icon$2a;
exports.Alert = Alert;
...
exports.BinanceChainIcon = Icon$1$;
exports.BinanceIcon = Icon$20;
exports.BlockIcon = Icon$2e;
...
exports.CheckmarkCircleFillIcon = Icon$1P;
exports.CheckmarkCircleIcon = Icon$2g;
...
exports.CommunityFilledIcon = Icon$1G;
